...
from daily_updater.parliament.initiatives.extract import _split_vote_result
from daily_updater.common import MyDict
...
class TestProvider(TestCase):
    def test_split_vote(self):
        ...
        self.assertDictEqual(
            res, {"afavor": "ps,psd,be,pcp,cds-pp,pan,pev,ch,il,cr,jkm".split(",")}
        )
        ...
        self.assertDictEqual(res, {"ausência": "ch".split(",")})
